                    ...
                    <div class="d-flex h-100 p-h-40 p-v-15 flex-column justify-content-between">
                        ...
                        <div class="d-flex justify-content-center mb-2">
                            <div style="background: white; display: inline-block; padding: 10px 30px; border-radius: 8px;">
                                <img src="<?= base_url('assets/images/logo/logo.png'); ?>" alt="Logo" style="height:80px;">
                            </div>
                        </div>

                        <!-- Middle Content -->
                        <div>
                            <h2 class="text-white m-b-20 font-weight-normal">
                                Human Resource Management Information System (HRMIS)
                            </h2>

                            <p class="text-white font-size-16 lh-2 w-80 opacity-08">
                                A centralized digital platform designed to manage employee records, 
                                track HR operations, and streamline human resource processes including 
                                recruitment, postings, transfers, and reporting.
                            </p>

                            <p class="text-white mt-4 opacity-08">
                                ✔ Employee Record Management<br>
                                ✔ Recruitment & User Management<br>
                                ✔ Posting & Transfer Tracking<br>
